...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/isakhammer/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/isakhammer/LARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Isaks Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Luke" 10 60
